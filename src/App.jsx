...
import { AlertTriangle, Shield, Search, MapPin, DollarSign, Clock, Users, CreditCard, CheckCircle, XCircle, LucideTractor, Zap, Ban, ArrowDownLeft, ArrowUpRight } from 'lucide-react'
import './App.css'
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Badge variant="outline">Acquiring</Badge>
                    </div>
                  </div>
                  <div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 rounded-xl bg-blue-50/50 border border-blue-100/50 group hover:bg-blue-50 transition-colors">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="p-2 bg-blue-100 rounded-lg text-blue-600 group-hover:scale-110 transition-transform">
                        <Clock className="h-4 w-4" />
                      </div>
                      <h4 className="font-semibold text-slate-900">Near Real Time (NRT)</h4>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed">
                      Used for detection and analysis where immediate action isn't critical, but timely intervention is still necessary.
                    </p>
                  </div>

                  <div className="p-4 rounded-xl bg-amber-50/50 border border-amber-100/50 group hover:bg-amber-50 transition-colors">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="p-2 bg-amber-100 rounded-lg text-amber-600 group-hover:scale-110 transition-transform">
                        <Zap className="h-4 w-4" />
                      </div>
                      <h4 className="font-semibold text-slate-900">Real Time (RT)</h4>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed">
                      Designed for immediate action to prevent suspicious activities.
                    </p>
                  </div>
                </div>
              </CardContent>
      ...
      <section id="review" className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="mt-8 border-red-100 bg-red-50/20">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-red-900 font-bold">
                ...
                Prohibited Industries (Non-Permissible)
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-red-800 mb-4 font-medium opacity-85">
                Any business that sells restricted, regulated, or illegal products, including but not limited to:
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="p-3 bg-white/60 rounded-lg border border-red-100/50">
                    <h4 className="text-xs font-bold text-red-900 uppercase tracking-wider mb-2">Restricted Substances</h4>
                    <ul className="space-y-2 text-slate-700 text-sm">
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Illegal narcotics and illicit drugs (e.g., cocaine, heroin, fentanyl).</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Psilocybin mushrooms, LSD, and other hallucinogenic substances.</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Cannabis, cannabis products, and related accessories.</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Drug paraphernalia and substances designed to mimic illegal drugs.</span>
                      </li>
                    </ul>
                  </div>
                  <div className="p-3 bg-white/60 rounded-lg border border-red-100/50">
                    <h4 className="text-xs font-bold text-red-900 uppercase tracking-wider mb-2">Nicotine & Tobacco</h4>
                    <ul className="space-y-2 text-slate-700 text-sm">
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Cigarettes, tobacco products, and unregulated nicotine products.</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Vapes, e-cigarettes, e-liquids, and vaping-related accessories.</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Nicotine pouches and herbal smoking products.</span>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="space-y-4 flex flex-col justify-between">
                  <div className="p-3 bg-white/60 rounded-lg border border-red-100/50">
                    <h4 className="text-xs font-bold text-red-900 uppercase tracking-wider mb-2">Pharmaceuticals</h4>
                    <ul className="space-y-2 text-slate-700 text-sm">
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Prescription medications and pharmaceutical products.</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Online pharmacies and prescription delivery services.</span>
                      </li>
                    </ul>
                  </div>
                  <div className="p-3 bg-white/60 rounded-lg border border-red-100/50 flex-grow">
                    <h4 className="text-xs font-bold text-red-900 uppercase tracking-wider mb-2">Adult Content</h4>
                    <ul className="space-y-2 text-slate-700 text-sm">
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Pornography and explicit adult services.</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span>Independent or subscription-based adult content creation.</span>
                      </li>
                    </ul>
                  </div>
                  <div className="p-3 bg-red-100/30 rounded-lg border border-red-200/50 flex items-center gap-3">
                    <AlertTriangle className="h-5 w-5 text-red-600 flex-shrink-0" />
                    <p className="text-xs text-red-900 font-semibold leading-tight">
                      Alerts involving these industries must be flagged for immediate compliance review.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card className="mt-8 overflow-hidden transition-all duration-300 hover:shadow-xl border-slate-200">
            <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
              <CardTitle className="text-xl font-bold flex items-center gap-3">
                <div className="p-2 bg-blue-600 rounded-lg text-white">
                  <Shield className="h-5 w-5" />
                </div>
                Incoming vs. Outgoing Reviews
              </CardTitle>
            </CardHeader>
              ...
              <div className="grid md:grid-cols-2 divide-x divide-slate-100">
                <div className="p-6 bg-red-50/10">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-red-900 text-base">Incoming (High Risk)</h4>
                      <Badge className="bg-red-500 text-white text-[10px] h-4 uppercase tracking-tighter hover:bg-red-600">Source Focus</Badge>
                    </div>
                  </div>
                  <p className="text-sm text-slate-700 leading-relaxed mb-5">
                    Our primary focus is on the <strong>Source of Funds</strong>. We strictly prohibit our clients from acting as merchants or processors for the prohibited industries.
                  </p>
                  <div className="p-4 bg-red-50 rounded-xl border border-red-100/50 flex gap-3 items-start shadow-sm shadow-red-100/50">
                    <AlertTriangle className="h-5 w-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <p className="text-xs text-red-900 font-semibold leading-relaxed">
                      If a client is receiving money from drug sales, adult content, or unregulated pharmaceuticals, this is a <span className="underline">critical violation</span> that must be flagged immediately.
                    </p>
                  </div>
                </div>

                <div className="p-6 bg-blue-50/5">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="p-2.5 bg-blue-100 rounded-xl text-blue-600">
                      <ArrowUpRight className="h-5 w-5" />
                    </div>
                    <div>
                      <h4 className="font-bold text-slate-900 text-base">Outgoing (Lower Risk)</h4>
                      <Badge className="bg-blue-500 text-white text-[10px] h-4 uppercase tracking-tighter hover:bg-blue-600">Usage Focus</Badge>
                    </div>
                  </div>
                  <p className="text-sm text-slate-700 leading-relaxed">
                    Once funds are legitimately deposited, clients have <strong>full autonomy</strong> over how they spend their capital. While we still monitor for sanctions and fraud, we do not restrict clients from spending money at merchants in these categories.
                  </p>
                  <div className="mt-5 p-3 rounded-lg bg-slate-100/50 border border-slate-200/50">
                    <p className="text-xs text-slate-500 italic flex items-center gap-2">
                       <CheckCircle className="h-3.5 w-3.5 text-blue-500" />
                       Example: Purchasing legal cannabis or tobacco is generally permitted, provided the transaction is not suspicious or sanctioned.
                    </p>
                  </div>
                </div>
              </div>
